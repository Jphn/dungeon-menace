...
public class Player extends Entity {
    ...
    public Player(GamePanel gp, KeyHandler keyH) {
        ...
        /*
         * Aqui subtraimos por metade do tileSize para ficar exatamente no meio da tela,
         * sem isso o personagem
    ...
    public void update() {
        if (knockBack == true) {
            ...
            // MARCAÇÃO: talvez esse if seja muito desnecessário, talvez tenha uma maneira
            // mais simples ?
    ...
    public void draw(Graphics2D g2) {
        ...
        // g2.setColor(Color.white);
        // g2.drawString("Invincible: " + invincibleCounter, 10, 400); //Para mostrar
    ...
    public void setScore() {
        long duration = Duration.between(this.start, Instant.now()).toSeconds();

        System.out.println("Duração: " + duration);

        this.score = this.level * this.exp * 1000 / duration;
